...
def uvmultifit(vis, spw=0, field=0, scans=[], column='data', uniform=False,
    ...
    Args:
       ...
       column (str): The data columns, it should be either ``data`` or ``corrected``.
    ...
    Results:
       dict: A dictionary with the fit results.
       ...
       * ['covariance']: The full covariance matrix of the parameters
         (in case the user asked for it).
